...
// instead of IO-flags. Inserted "wait for return code" at the end. // 2012-10-21: Revised by Anne. Converted to English version and VS2012
//-----------------------------------------------------------------------
#include <iostream> // Preprocessor directives
#include <iomanip>
using namespace std;
int main() // *FIXED* main should return an int not void.
{
	...
	int weeklyWages = hoursPerWeek * hourlyWages; // *FIXED* weeklyWages should be of datatype int.
	...
	cout << " Given an hourly wage of " << hourlyWages << " kr" << endl
		...
		<< "the weekly wages will be: " << weeklyWages << " kr" << endl; // *FIXED* added missing semi-colon at the end of this expression.
